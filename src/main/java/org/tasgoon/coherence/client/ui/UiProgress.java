...
import org.tasgoon.coherence.client.ProgressBar;
...
public class UiProgress extends GuiScreen implements ProgressBar {
    ...
    public void drawScreen(int x, int y, float renderPartialTicks) {
        ...
        this.drawGradientRect(10, height / 3, (int) (10 + (width - 20) * getPercentage()), height / 3 + 10, -99000000, -99000000); //Obscure color integers obtained by guess-and-check.
